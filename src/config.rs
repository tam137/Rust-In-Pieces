...
impl Config {
    pub fn new() -> Config {
        Config {
            ...
            rook_behind_passed_pawn_middlegame: 25,
            rook_behind_passed_pawn_endgame: 50,
            king_ring_attack_knight: 6,
            king_ring_attack_bishop: 6,
            king_ring_attack_rook: 9,
            king_ring_attack_queen: 16,
            protected_passed_pawn_middlegame: 20,
            protected_passed_pawn_endgame: 40,
