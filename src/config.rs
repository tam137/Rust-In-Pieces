...
impl Config {
    pub fn new() -> Config {
        Config {
            ...
            is_hashed_rank_bonus: 8,
            give_check_rank_bonus: 4,
            is_pv_node_rank_bonus: 14,
            give_promotion_rank_bonus_queen: 9,
            ...
            rook_open_file: 18,
            rook_half_open_file: 25,
            bishop_pair_bonus: 50,
            rook_doubled_bonus: 60,
            rook_behind_passed_pawn_middlegame: 6,
            rook_behind_passed_pawn_endgame: 27,
            king_ring_attack_knight: 1,
            king_ring_attack_bishop: 1,
            king_ring_attack_rook: 1,
            king_ring_attack_queen: 2,
            protected_passed_pawn_middlegame: 28,
            protected_passed_pawn_endgame: 0,
            king_opposition_bonus: 7,
            king_open_file_malus: 50,
            king_half_open_file_malus: 50,
            king_ring_defender_value: 2,

            pawn_structure: 4,
            pawn_supports_knight_outpost: 9,
            pawn_centered: 34,
            pawn_undeveloped_malus: 19,
            pawn_on_last_rank_bonus: 191,
            pawn_on_before_last_rank_bonus: 136,
            pawn_on_before_before_last_rank_bonus: 59,
            pawn_defends_bishop: 26,
            pawn_double_malus: 19,

            knight_on_rim_malus: 19,
            knight_centered: 26,
            knight_blockes_pawn: 18,
            bishop_trapped_at_rim_malus: 57,

            pawn_attacks_opponent_fig: 30,
            pawn_attacks_opponent_fig_with_tempo: 5,
            queen_in_attack: 59,
            queen_in_attack_with_tempo: 27,
            knight_attacks_bishop: 1,
            knight_attacks_rook: 0,
            knight_attacks_bishop_tempo: 9,
            knight_attacks_rook_tempo: 19,
            threat_minor_attacks_rook: 11,
            threat_minor_attacks_queen: 22,
            threat_rook_attacks_queen: 28,


            king_pawn_shield: 61,
            king_piece_shield: 8,
            king_trapp_at_baseline_malus: 91,
            king_in_check_malus: 153,
            king_in_double_check_malus: 314,

            rook_on_seventh: 12,
            pawn_isolated_malus: 3,
            pawn_backward_malus: 20,
            knight_mobility_factor: 1,
            bishop_mobility_factor: 0,
            rook_mobility_factor: 0,
            pre_sort_moves: true,
