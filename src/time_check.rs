...
pub fn run_time_check(global_map: &ThreadSafeDataMap, local_map: &mut DataMap) {
...
pub fn calculate_benchmark (global_map: &Arc<RwLock<DataMap>>, local_map: &mut DataMap) -> i32 {
