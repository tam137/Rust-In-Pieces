# LCT II Test Results: Version v0.12.4

* **Engine Binary**: `target/release/suprah`
* **Positions Solved**: 6 / 35 (17.1%)
* **Total Points**: 180 / 1050
* **Estimated ELO**: **2080 ELO** (Variants-Based Easy-Move Fix)
...
### Scoreboard by Category (v0.12.4)
...
| LCTII.TAC.04 | Tactical | Hort - Wade, Pajulahti 1974 | e5f6 | e5f6 | **YES** | 6.37s | 30 |
| LCTII.TAC.05 | Tactical | Fischer - Myagmarsuren, Sousse 1967 | h3h7 | h3h7 | **YES** | 8.83s | 30 |
...
| LCTII.END.01 | Endgame | Pawn Endgame Study | f5f6 | f5f6 | **YES** | 1.11s | 30 |
