# LCT II Test Results: Version v0.10.5

* **Engine Binary**: `target/release/suprah`
* **Positions Solved**: 6 / 35 (17.1%)
* **Total Points**: 180 / 1050
* **Estimated ELO**: **2080 ELO** (Asymmetric soft-capping active with 5x damping, bishop rim-trapping bug fixed, and patzer static tempo threat bonuses scaled down to minimal cp values to avoid overfitting and eliminate short-term threat shadowboxing in real tournament play.)
...
## Scoreboard by Category (v0.10.5)
...
| LCTII.POS.03 | Positional | Boissel - Boulard, corr. 1994 | f2c5 | e1e2 | **NO** | - | 0 |
...
| LCTII.POS.08 | Positional | Unzicker - Fischer, Varna 1962 | g2h3 | f1d1 | **NO** | - | 0 |
...
| LCTII.POS.13 | Positional | Karpov - Kasparov, Moskau 1985 | c3a2 | c3a2 | **YES** | 1.14s | 30 |
...
| LCTII.TAC.02 | Tactical | Keres - Eliskases, Noordwijk 1938 | h5h7 | h5h7 | **YES** | 0.11s | 30 |
| LCTII.TAC.03 | Tactical | Drimer - Rellstab, corr. 1968 | f6f3 | a3c3 | **NO** | - | 0 |
| LCTII.TAC.04 | Tactical | Hort - Wade, Pajulahti 1974 | e5f6 | e5f6 | **YES** | 0.22s | 30 |
...
| LCTII.END.02 | Endgame | Rook Endgame Study | f4f5 | f4f5 | **YES** | 0.17s | 30 |
| LCTII.END.03 | Endgame | Bishop Endgame Study | c6e4 | c6e4 | **YES** | 7.80s | 30 |
